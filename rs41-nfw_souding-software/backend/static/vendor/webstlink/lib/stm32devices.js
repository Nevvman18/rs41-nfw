...
export default [
    ...
    },
    {
        ...
        'devices': [
            ...
            {
                // RS41-NFW addition: STM32L41x / L42x (dev_id 0x464) - the RSM4x4 / RSM4x5
                // MCU. Upstream webstlink omits this group; the STM32L4 driver added here
                // handles its 2 KB-page, single-bank flash and the RDP/WRP unlock.
                'dev_id': 0x464,
                'flash_size_reg': 0x1fff75e0,
