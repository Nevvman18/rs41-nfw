...
int ovhtWarnValue = 100;  //overheating warning
int ovhtErrValue = 100;   //overheating error
...
int heatingPwmUpperLimit = 120; //These three values shouldn't be changed, unless you know what they mean
